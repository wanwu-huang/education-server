...
public class SingleLoginTokenServices extends DefaultTokenServices {
    ...
    public SingleLoginTokenServices (
    ...
    public OAuth2AccessToken createAccessToken ( OAuth2Authentication authentication ) throws AuthenticationException {
        ...
        // expired.
            ...
            if ( System.currentTimeMillis ( ) > expiring.getExpiration ( )
                                                        .getTime ( ) ) {
                refreshToken = createRefreshToken ( authentication );
            }
        }
    ...
    private OAuth2AccessToken createAccessToken (
        ...
        if ( validitySeconds > 0 ) {
            token.setExpiration ( new Date ( System.currentTimeMillis ( ) + ( validitySeconds) ) );
        }
        token.setRefreshToken ( refreshToken );
        token.setScope ( authentication.getOAuth2Request ( )
                                       .getScope ( ) );
