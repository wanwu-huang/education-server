...
/**
 * @Title 数学计算工具类
 * @Description //TODO 提供常用的数值加减乘除计算 , 及多个数值的求和 , 平均值 , 最大最小值计算
 * @Author LIMINGWEI
 * @Date 2021/1/7 11:40
 */
public class MathUtil {
    ...
    public static String subtract (
        ...
        BigDecimal b1 = new BigDecimal ( v1.trim ( ) );
        BigDecimal b2 = new BigDecimal ( v2.trim ( ) );
        return String.valueOf ( subtract ( b1 ,
                                           b2 ) );
    }
    ...
    public static String multiply (
        ...
        BigDecimal b1 = new BigDecimal ( v1.trim ( ) );
        BigDecimal b2 = new BigDecimal ( v2.trim ( ) );
        return String.valueOf ( multiply ( b1 ,
                                           b2 ) );
    }
     ...
     * @return 两个参数的商(String)
     */
    public static String divideSales (
            String v1 ,
            String v2, int v3 ) {
        return divide ( v1 ,
                v2 ,
    ...
    public static String divide (
        ...
        BigDecimal b1 = new BigDecimal ( v1.trim ( ) );
        BigDecimal b2 = new BigDecimal ( v2.trim ( ) );
        return String.valueOf ( divide ( b1 ,
                                         b2 ,
                                         scale ) );
    }
    ...
    public static BigDecimal avg ( BigDecimal... valList ) {
        if ( null != valList && valList.length != 0 ) {
            return divide ( sum ( BigDecimal.ZERO ,
                                  valList ) ,
                            new BigDecimal ( valList.length ) );
        }
        return BigDecimal.ZERO;
    }
     ...
     * @return
     */
    public static String dealRate(double score) {
        if (score == 0) {
            return "0%";
        } else {
     ...
     * @return
     */
    public static String formatRate(double score) {
        if (score == 0) {
            return "0";
        } else {
            return String.format("%.1f", score);
    ...
    public static void main ( String[] args ) {
        ...
        Integer fuLow = 2;
        Integer fuLowQueCount = 3;

        BigDecimal bfuLow = BigDecimal.valueOf ( fuLow );
        BigDecimal bfuLowQueCount = BigDecimal.valueOf ( fuLowQueCount );
        BigDecimal result = MathUtil.divide ( bfuLow ,
                                              bfuLowQueCount );
