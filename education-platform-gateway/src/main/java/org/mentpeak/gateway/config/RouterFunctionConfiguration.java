package org.mentpeak.gateway.config;
...
public class RouterFunctionConfiguration {
     ...
     */
    private static final String ALLOWED_HEADERS = "x-requested-with, platform-auth, Content-Type, Authorization, credential, X-XSRF-TOKEN, token, username, client,mic-trace-id";
